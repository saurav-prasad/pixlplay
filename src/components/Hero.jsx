  ...
  return (
    <>
      ...
      >
        ...
        <p class="mx-auto mt-6 max-w-2xl font-normal text-lg tracking-tight text-[#1d1c2d]">
          <span
            className="font-whisper font-extrabold text-[2.1rem] text-indigo-700
            "
          >
            Pixl Play
          </span>{" "}
          is the leading whiteboard application on the internet. Whether you're
        ...
        <div class="mt-10 flex justify-center items-center gap-x-6">
          <Link
            class="group inline-flex items-center justify-center rounded-full py-3 px-5 font-medium focus:outline-none focus-visible:outline-2 shadow-2xl focus-visible:outline-offset-2 bg-[#0f172ad5] text-white backdrop-blur-[100px] hover:bg-slate-800 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 group"
            variant="solid"
            color="slate"
        ...
        {/* footer */}
        <footer class="absolute bottom-0 left-0 right-0 flex flex-col items-center border-t border-slate-400/10 py-4 sm:flex-row-reverse sm:justify-between bg-[#00000078] backdrop-blur-[100px] shadow-lg">
          ...
          <p class="mt-2 text-sm text-slate-500 sm:mt-0">
